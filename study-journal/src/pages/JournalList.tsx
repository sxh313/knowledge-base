...
export default function JournalList() {
  ...
  return (
    <div className="flex flex-col h-full animate-fade-in">
      ...
      {/* 首次使用引导 */}
      {showOnboarding && (
        <div className="mt-2 rounded-xl border border-[var(--color-primary)] border-opacity-30 bg-[var(--color-primary-light)] p-4 animate-fade-in" style={{ borderColor: 'color-mix(in srgb, var(--color-primary) 30%, transparent)' }}>
